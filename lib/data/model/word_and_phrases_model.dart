...
WordAndPhrasesModel wordWithPhrasesModelFromJson(String str) => WordAndPhrasesModel.fromJson(json.decode(str));

String wordWithPhrasesModelToJson(WordAndPhrasesModel data) => json.encode(data.toJson());
